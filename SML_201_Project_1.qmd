...
paste("The greatest rate of growth happened during year", greatest_growth, "qtr", greatest_growth_qtr) 
...
```{r b1b}
# range is not referring to the interval here right?? it's referring to the difference right??
...
# lmk if this needs to be styled more bc idk 
hchart(
  object = dis_plus,
...
# need to finish the second part
